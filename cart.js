...
let generate_Cart_item = () => {
    if (basket.length !== 0) {
        ...
        shoppingcart.innerHTML = `<h2 class="cart-empty"> Your cart is empty</h2>`;
...
function goToPayment() {
    // Optional: Save the order total to localStorage
    let orderTotal = basket.reduce((acc, item) => acc + item.item * item.price, 0);
...
let Total_amount = () => {
    ...
    if (basket.length !== 0) {
        ...
        <hr>
        <div class="total-item">
            <button class="place-order" onclick="goToPayment()">Place order</button>
            <h3 class="cart-total">Total</h3>
            ...
            return `
                <div class="cart-item">
                    ...
                    <div class="cart-detail">
                        ...
                        <div>
                            <p class="cart-title">${name}</p>
                            <img class="rat" src="https://www.pngkey.com/png/full/118-1184489_review-stars-png.png" alt="rating">
                            <div class="remove">
                                <p class="bought">10K+ bought in past month</p>
                                <button onclick="remove_from_cart('${id}')" class="cart-remove">Remove</button>
                            </div>
        ...
        label.innerHTML = `
            ...
            <div class="total-item">
                ...
                <div class="total-label">
                    <h3 class="cart-total-price"> Total Rs. ${total_amount.toFixed(2)}</h3>
                </div>
            </div>
        `;
    } else {
